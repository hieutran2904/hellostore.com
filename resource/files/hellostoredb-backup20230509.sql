...
--
-- Host: 127.0.0.1
-- Generation Time: May 09, 2023 at 09:41 AM
...
(1, 1, 1, '55555555555555', '5', '0', '2023-05-09 09:40:44', NULL, 1, 'Inactive');
...
--
ALTER TABLE `invoices`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'INVOICES ID', AUTO_INCREMENT=4;
...
--
ALTER TABLE `reviews`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'REVIEW ID', AUTO_INCREMENT=2;
...
--
ALTER TABLE `shopcarts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'SHOPCART ID', AUTO_INCREMENT=51;
