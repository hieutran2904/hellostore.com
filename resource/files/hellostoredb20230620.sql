...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 20, 2023 at 10:49 AM
...
(28, 'Áo Nam Test', 'Active', '0', '2023-05-29 11:08:45', '2023-05-29 11:08:45'),
...
(2, 'Xeko', 'test@gmail.com', '123', 'Hà Nội', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 'Active', '0', '2023-05-03 09:24:35', '2023-05-19 10:10:37', 'customer_20230519101037.jpg'),
...
(1, 'hihihi', 50000, 100, 'Active', '0', NULL, '2023-05-26 17:01:26'),
(2, 'hahaha', 70000, 100, 'Active', '0', NULL, '2023-05-26 17:02:41'),
(3, 'keke', 10000, 99, 'Inactive', '0', '2023-05-26 16:57:03', '2023-05-29 18:49:47');
...
(1, 1, '2023-05-09 14:21:55', 749000, 0, 70000, 679000, 'Cash On Delivery', '14007768', 'Paid', 'Processing', '0', NULL, NULL),
...
(5, 2, '2023-05-09 22:44:10', 590000, 0, 0, 590000, 'Cash On Delivery', 'COD20230509224410', 'Unpaid', 'Pending', '0', NULL, NULL),
...
(1, 1, 1, '5 sao nha shop', '5', '0', '2023-05-09 09:40:44', '2023-05-18 06:19:01', 1, 'Active'),
(9, 1, 53, 'ưng quá chừng - hiếu đánh giá', '5', '0', '2023-05-10 19:27:11', '2023-05-10 19:28:24', 8, 'Active'),
(10, 1, 25, 'anh hiếu đẹp zai', '5', '0', '2023-05-10 19:30:20', '2023-05-10 19:30:50', 1, 'Active'),
(11, 2, 53, 'quần đẹp quá shop - test đánh giá update', '3', '0', '2023-05-10 19:32:06', '2023-05-15 11:21:31', 5, 'Active'),
(12, 2, 15, 'ưngggggggggggggg quá chừngggggggggg', '4', '0', '2023-05-10 19:34:25', '2023-05-15 10:53:19', 4, 'Active'),
(13, 2, 18, 'hihi haha', '5', '0', '2023-05-11 05:17:10', '2023-05-11 05:17:19', 7, 'Active'),
...
(19, 2, 15, '2 sao', '2', '0', '2023-05-15 11:53:02', NULL, 6, 'Inactive'),
...
(83, 1, 15, 1, '0', '2023-05-26 12:03:23', NULL),
(115, 3, 85, 5, '0', '2023-06-05 09:24:26', NULL);
...
--
ALTER TABLE `categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'CATEGORIES ID', AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT for table `customers`
--
ALTER TABLE `customers`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'CUSTOMERS ID', AUTO_INCREMENT=4;
...
--
ALTER TABLE `invoices`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'INVOICES ID', AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `orders`
--
ALTER TABLE `orders`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ORDERS ID', AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `order_items`
--
ALTER TABLE `order_items`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ORDER ITEMS ID', AUTO_INCREMENT=32;
...
--
ALTER TABLE `products_sc`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PRODUCTS SC ID', AUTO_INCREMENT=116;

--
-- AUTO_INCREMENT for table `reviews`
--
ALTER TABLE `reviews`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'REVIEW ID', AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `shippings`
--
ALTER TABLE `shippings`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'SHIPPING ID', AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `shopcarts`
--
ALTER TABLE `shopcarts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'SHOPCART ID', AUTO_INCREMENT=118;
