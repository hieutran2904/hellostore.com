...
?>
            <tr>
                ...
                <td>
                    <a class="btn <?= $eachReview['review_status'] == 'Active' ? 'btn-success' : 'btn-danger' ?> mb-1" href="" data-toggle="tooltip" data-placement="top" title="Change">
