        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <h4 class="card-title col-md-11">Data Table Sub-Category</h4>
                            <div class="bootstrap-modal col-md-1">
                                <a class="btn btn-success" href="manage-subcategory.php" data-toggle="tooltip" data-placement="top" title="Add">
